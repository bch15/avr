...
; 0000 0042 DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(255)
	OUT  0x14,R30
...
; 0000 009A       {
; 0000 009B 
; 0000 009C         PORTC=0b10000110;
	LDI  R30,LOW(134)
	OUT  0x15,R30
; 0000 009D         check1();
	RCALL _check1
; 0000 009E         PORTC=0b10001010;
	LDI  R30,LOW(138)
	OUT  0x15,R30
; 0000 009F         check2();
	RCALL _check2
; 0000 00A0         PORTC=0b00110001;
	LDI  R30,LOW(49)
	OUT  0x15,R30
; 0000 00A1         check1();
	RCALL _check1
; 0000 00A2         PORTC=0b01010001;
	LDI  R30,LOW(81)
	OUT  0x15,R30
; 0000 00A3         check2();
	RCALL _check2
