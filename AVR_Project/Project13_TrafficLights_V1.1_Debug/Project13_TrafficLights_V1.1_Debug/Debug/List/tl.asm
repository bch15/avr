...
_0x4:
	...
	BRLT _0x5
; 0000 0020   {
; 0000 0021     if(PINB.0==1)
	SBIS 0x16,0
	RJMP _0x6
; 0000 0022         {
; 0000 0023            PORTC=0b00110001;
	LDI  R30,LOW(49)
	OUT  0x15,R30
; 0000 0024         }
; 0000 0025     delay_ms(20);
_0x6:
	LDI  R26,LOW(20)
	LDI  R27,0
	CALL _delay_ms
...
; 0000 002E     if(PINB.0==1)
	...
	RJMP _0xA
; 0000 002F         {
; 0000 0030            PORTC=0b00110001;
	LDI  R30,LOW(49)
	OUT  0x15,R30
; 0000 0031         }
; 0000 0032     delay_ms(20);
_0xA:
	LDI  R26,LOW(20)
	LDI  R27,0
	CALL _delay_ms
...
; 0000 0042 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	OUT  0x17,R30
; 0000 0043 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=0
...
; 0000 00A0       {
; 0000 00A1 
; 0000 00A2           if(PORTC==0b00110001)
	IN   R30,0x15
	CPI  R30,LOW(0x31)
	BREQ _0xF
; 0000 00A3             goto label;
; 0000 00A4           PORTC=0b10000110;
	LDI  R30,LOW(134)
	OUT  0x15,R30
; 0000 00A5           check1();
	RCALL _check1
; 0000 00A6           if(PORTC==0b00110001)
	IN   R30,0x15
	CPI  R30,LOW(0x31)
	BREQ _0xF
; 0000 00A7             goto label;
; 0000 00A8           PORTC=0b10001010;
	LDI  R30,LOW(138)
	OUT  0x15,R30
; 0000 00A9           check2();
	RCALL _check2
; 0000 00AA     label:
_0xF:
; 0000 00AB           PORTC=0b00110001;
	LDI  R30,LOW(49)
	OUT  0x15,R30
; 0000 00AC           check1();
	RCALL _check1
; 0000 00AD           PORTC=0b01010001;
	LDI  R30,LOW(81)
	OUT  0x15,R30
; 0000 00AE           check2();
	RCALL _check2
