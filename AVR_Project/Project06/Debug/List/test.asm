...
;flash byte char0[8]={16,16,16,16,16,16,16,16};
;flash byte char1[8]={24,24,24,24,24,24,24,24};
;flash byte char2[8]={30,30,30,30,30,30,30,30};
;flash byte char3[8]={31,31,31,31,31,31,31,31};
;flash byte char4[8]={1,1,1,1,1,1,1,1};
;flash byte char5[8]={3,3,3,3,3,3,3,3};
;flash byte char6[8]={7,7,7,7,7,7,7,7};
;flash byte char7[8]={0,0,0,0,0,0,0,0};
;
...
;	a -> R16
	...
	ORI  R30,0x40
	MOV  R16,R30
; 0000 002C for(i=0;i<8;i++) lcd_write_byte(a++,*pc++);
	LDI  R17,LOW(0)
_0x4:
	CPI  R17,8
	BRSH _0x5
...
; 0000 0036 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(0)
	OUT  0x1A,R30
...
; 0000 0097 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0098 
; 0000 0099 // Alphanumeric LCD initialization
; 0000 009A // Connections are specified in the
; 0000 009B // Project|Configure|C Compiler|Libraries|Alphanumeric LCD menu:
; 0000 009C // RS - PORTA Bit 0
; 0000 009D // RD - PORTA Bit 1
; 0000 009E // EN - PORTA Bit 2
; 0000 009F // D4 - PORTA Bit 4
; 0000 00A0 // D5 - PORTA Bit 5
; 0000 00A1 // D6 - PORTA Bit 6
; 0000 00A2 // D7 - PORTA Bit 7
; 0000 00A3 // Characters/line: 8
; 0000 00A4 lcd_init(20);
	LDI  R26,LOW(20)
	CALL _lcd_init
; 0000 00A5 
; 0000 00A6 define_char(char0,0);
...
_0xA:
	...
	BRLT _0xB
; 0000 00B3         {
; 0000 00B4               lcd_gotoxy(i,0);
	CALL SUBOPT_0x0
; 0000 00B5               lcd_putchar(0);
	LDI  R26,LOW(0)
	CALL SUBOPT_0x1
; 0000 00B6               lcd_gotoxy(j,0);
; 0000 00B7               lcd_putchar(4);
	LDI  R26,LOW(4)
	CALL SUBOPT_0x2
; 0000 00B8               lcd_gotoxy(i,1);
; 0000 00B9               lcd_putchar(0);
	LDI  R26,LOW(0)
	CALL SUBOPT_0x3
; 0000 00BA               lcd_gotoxy(j,1);
; 0000 00BB               lcd_putchar(4);
	LDI  R26,LOW(4)
	CALL SUBOPT_0x4
; 0000 00BC               delay_ms(1);
; 0000 00BD 
; 0000 00BE               lcd_gotoxy(i,0);
; 0000 00BF               lcd_putchar(1);
	LDI  R26,LOW(1)
	CALL SUBOPT_0x1
; 0000 00C0               lcd_gotoxy(j,0);
; 0000 00C1               lcd_putchar(5);
	LDI  R26,LOW(5)
	CALL SUBOPT_0x2
; 0000 00C2               lcd_gotoxy(i,1);
; 0000 00C3               lcd_putchar(1);
	LDI  R26,LOW(1)
	CALL SUBOPT_0x3
; 0000 00C4               lcd_gotoxy(j,1);
; 0000 00C5               lcd_putchar(5);
	LDI  R26,LOW(5)
	CALL SUBOPT_0x4
; 0000 00C6               delay_ms(1);
; 0000 00C7 
; 0000 00C8               lcd_gotoxy(i,0);
; 0000 00C9               lcd_putchar(2);
	LDI  R26,LOW(2)
	CALL SUBOPT_0x1
; 0000 00CA               lcd_gotoxy(j,0);
; 0000 00CB               lcd_putchar(6);
	LDI  R26,LOW(6)
	CALL SUBOPT_0x2
; 0000 00CC               lcd_gotoxy(i,1);
; 0000 00CD               lcd_putchar(2);
	LDI  R26,LOW(2)
	CALL SUBOPT_0x3
; 0000 00CE               lcd_gotoxy(j,1);
; 0000 00CF               lcd_putchar(6);
	LDI  R26,LOW(6)
	CALL SUBOPT_0x4
...
; 0000 00D3               lcd_putchar(3);
	LDI  R26,LOW(3)
	CALL SUBOPT_0x1
; 0000 00D4               lcd_gotoxy(j,0);
; 0000 00D5               lcd_putchar(3);
	LDI  R26,LOW(3)
	CALL SUBOPT_0x2
; 0000 00D6               lcd_gotoxy(i,1);
; 0000 00D7               lcd_putchar(3);
	LDI  R26,LOW(3)
	CALL SUBOPT_0x3
; 0000 00D8               lcd_gotoxy(j,1);
; 0000 00D9               lcd_putchar(3);
	LDI  R26,LOW(3)
	CALL SUBOPT_0x5
; 0000 00DA               delay_ms(1);
; 0000 00DB               j--;
	SBIW R30,1
	MOVW R6,R30
; 0000 00DC          }
...
_0xD:
	...
	BRLT _0xE
; 0000 00E1         {
; 0000 00E2               lcd_gotoxy(i,0);
	CALL SUBOPT_0x0
; 0000 00E3               lcd_putchar(3);
	LDI  R26,LOW(3)
	CALL SUBOPT_0x1
; 0000 00E4               lcd_gotoxy(j,0);
; 0000 00E5               lcd_putchar(3);
	LDI  R26,LOW(3)
	CALL SUBOPT_0x2
...
; 0000 00E7               lcd_putchar(3);
	LDI  R26,LOW(3)
	CALL SUBOPT_0x3
; 0000 00E8               lcd_gotoxy(j,1);
; 0000 00E9               lcd_putchar(3);
	LDI  R26,LOW(3)
	CALL SUBOPT_0x4
; 0000 00EA               delay_ms(1);
; 0000 00EB 
; 0000 00EC               lcd_gotoxy(i,0);
; 0000 00ED               lcd_putchar(2);
	LDI  R26,LOW(2)
	CALL SUBOPT_0x1
; 0000 00EE               lcd_gotoxy(j,0);
; 0000 00EF               lcd_putchar(6);
	LDI  R26,LOW(6)
	CALL SUBOPT_0x2
; 0000 00F0               lcd_gotoxy(i,1);
; 0000 00F1               lcd_putchar(2);
	LDI  R26,LOW(2)
	CALL SUBOPT_0x3
; 0000 00F2               lcd_gotoxy(j,1);
; 0000 00F3               lcd_putchar(6);
	LDI  R26,LOW(6)
	CALL SUBOPT_0x4
; 0000 00F4               delay_ms(1);
; 0000 00F5 
; 0000 00F6               lcd_gotoxy(i,0);
; 0000 00F7               lcd_putchar(1);
	LDI  R26,LOW(1)
	CALL SUBOPT_0x1
; 0000 00F8               lcd_gotoxy(j,0);
; 0000 00F9               lcd_putchar(5);
	LDI  R26,LOW(5)
	CALL SUBOPT_0x2
; 0000 00FA               lcd_gotoxy(i,1);
; 0000 00FB               lcd_putchar(1);
	LDI  R26,LOW(1)
	CALL SUBOPT_0x3
; 0000 00FC               lcd_gotoxy(j,1);
; 0000 00FD               lcd_putchar(5);
	LDI  R26,LOW(5)
	CALL SUBOPT_0x4
...
; 0000 0101               lcd_putchar(7);
	LDI  R26,LOW(7)
	CALL SUBOPT_0x1
; 0000 0102               lcd_gotoxy(j,0);
; 0000 0103               lcd_putchar(7);
	LDI  R26,LOW(7)
	CALL SUBOPT_0x2
; 0000 0104               lcd_gotoxy(i,1);
; 0000 0105               lcd_putchar(7);
	LDI  R26,LOW(7)
	CALL SUBOPT_0x3
; 0000 0106               lcd_gotoxy(j,1);
; 0000 0107               lcd_putchar(7);
	LDI  R26,LOW(7)
	CALL SUBOPT_0x5
