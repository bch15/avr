...
; 0000 00AD                 end=num;
	MOVW R10,R8
; 0000 00AE                 if(PINA.0==1)
	SBIS 0x19,0
	RJMP _0xA
; 0000 00AF                 {
; 0000 00B0                     for(i=end; i>=0; i--)
	MOVW R4,R10
_0xC:
	CLR  R0
	CP   R4,R0
...
; 0000 00BC         }
; 0000 00BD 
; 0000 00BE         if(PINA.0==1)
_0x6:
	SBIS 0x19,0
	RJMP _0xF
; 0000 00BF         {
; 0000 00C0             for(i=end; i>=0; i--)
	MOVW R4,R10
_0x11:
	CLR  R0
	CP   R4,R0
...
; 0000 00C6                 num=end;
	MOVW R8,R10
; 0000 00C7                 if(PINA.0==0)
	SBIC 0x19,0
	RJMP _0x13
; 0000 00C8                 {
; 0000 00C9                     for(i=num; i<=255; i++)
	MOVW R4,R8
_0x15:
	LDI  R30,LOW(255)
	LDI  R31,HIGH(255)
