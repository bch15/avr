...
;flash byte char1[8]={31,0,0,0,0,0,0,0};
...
;flash byte char7[8]={31,31,31,31,31,31,31,31};
;
...
_0xD:
	...
	BRLT _0xE
; 0000 00B4            {
; 0000 00B5              lcd_gotoxy(i,0);
	RCALL SUBOPT_0x0
; 0000 00B6              lcd_putchar(j);
; 0000 00B7            }
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
...
_0xE:
	...
	RJMP _0xA
_0xB:
; 0000 00B8            delay_ms(60);
	RCALL SUBOPT_0x1
; 0000 00B9           for(j=0; j<=7; j++)
	CLR  R6
	CLR  R7
_0x10:
	LDI  R30,LOW(7)
...
_0x13:
	...
	BRLT _0x14
; 0000 00BB            {
; 0000 00BC              lcd_gotoxy(i,1);
	RCALL SUBOPT_0x2
; 0000 00BD              lcd_putchar(j);
; 0000 00BE            }
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
...
_0x14:
	...
	RJMP _0x10
_0x11:
; 0000 00BF            delay_ms(60);
	RCALL SUBOPT_0x1
; 0000 00C0 
; 0000 00C1         //***First-D***
; 0000 00C2 
; 0000 00C3           for(j=7; j>=0; j--)
	LDI  R30,LOW(7)
	LDI  R31,HIGH(7)
	MOVW R6,R30
_0x16:
...
_0x19:
	...
	BRLT _0x1A
; 0000 00C5            {
; 0000 00C6              lcd_gotoxy(i,1);
	RCALL SUBOPT_0x2
; 0000 00C7              lcd_putchar(j);
; 0000 00C8            }
	MOVW R30,R4
	SBIW R30,1
	MOVW R4,R30
...
_0x1A:
	...
	RJMP _0x16
_0x17:
; 0000 00C9            delay_ms(60);
	RCALL SUBOPT_0x1
; 0000 00CA           for(j=7; j>=0; j--)
	LDI  R30,LOW(7)
	LDI  R31,HIGH(7)
	MOVW R6,R30
_0x1C:
...
_0x1F:
	...
	BRLT _0x20
; 0000 00CC            {
; 0000 00CD              lcd_gotoxy(i,0);
	RCALL SUBOPT_0x0
; 0000 00CE              lcd_putchar(j);
; 0000 00CF            }
	MOVW R30,R4
	SBIW R30,1
	MOVW R4,R30
