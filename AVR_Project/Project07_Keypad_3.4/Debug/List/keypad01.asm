...
_0x0:
	...
	.DB  0x39,0x0,0x2A,0x0,0x30,0x0,0x23,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 00A0           PORTC.3= 1;
	SBI  0x15,3
; 0000 00A1           if(PINC.4==0 && PINC.5==1 && PINC.6==1)
	SBIC 0x13,4
	RJMP _0xF
	SBIS 0x13,5
	RJMP _0xF
...
; 0000 00A3           lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00A4           lcd_putsf("1");
	__POINTW2FN _0x0,0
	RCALL SUBOPT_0x1
; 0000 00A5           delay_ms(30);
; 0000 00A6 
; 0000 00A7           }
; 0000 00A8           if(PINC.4==1 && PINC.5==0 && PINC.6==1)
_0xE:
	SBIS 0x13,4
	RJMP _0x12
	SBIC 0x13,5
...
; 0000 00AA           lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00AB           lcd_putsf("2");
	__POINTW2FN _0x0,2
	RCALL SUBOPT_0x1
; 0000 00AC           delay_ms(30);
; 0000 00AD 
; 0000 00AE           }
; 0000 00AF           if(PINC.4==1 && PINC.5==1 && PINC.6==0)
_0x11:
	SBIS 0x13,4
	RJMP _0x15
	SBIS 0x13,5
...
; 0000 00B1           lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00B2           lcd_putsf("3");
	__POINTW2FN _0x0,4
	RCALL SUBOPT_0x1
; 0000 00B3           delay_ms(30);
; 0000 00B4           }
; 0000 00B5 
; 0000 00B6       //Row2:
; 0000 00B7 
...
; 0000 00BB           PORTC.3= 1;
	SBI  0x15,3
; 0000 00BC           if(PINC.4==0 && PINC.5==1 && PINC.6==1)
	SBIC 0x13,4
	RJMP _0x20
	SBIS 0x13,5
	RJMP _0x20
...
; 0000 00BE           lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00BF           lcd_putsf("4");
	__POINTW2FN _0x0,6
	RCALL SUBOPT_0x1
; 0000 00C0           delay_ms(30);
; 0000 00C1 
; 0000 00C2           }
; 0000 00C3           if(PINC.4==1 && PINC.5==0 && PINC.6==1)
_0x1F:
	SBIS 0x13,4
	RJMP _0x23
	SBIC 0x13,5
...
; 0000 00C5           lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00C6           lcd_putsf("5");
	__POINTW2FN _0x0,8
	RCALL SUBOPT_0x1
; 0000 00C7           delay_ms(30);
; 0000 00C8 
; 0000 00C9           }
; 0000 00CA           if(PINC.4==1 && PINC.5==1 && PINC.6==0)
_0x22:
	SBIS 0x13,4
	RJMP _0x26
	SBIS 0x13,5
...
; 0000 00D6           PORTC.3= 1;
	SBI  0x15,3
; 0000 00D7           if(PINC.4==0 && PINC.5==1 && PINC.6==1)
	SBIC 0x13,4
	RJMP _0x31
	SBIS 0x13,5
	RJMP _0x31
...
; 0000 00D9           lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00DA           lcd_putsf("7");
	__POINTW2FN _0x0,12
	RCALL SUBOPT_0x1
; 0000 00DB           delay_ms(30);
; 0000 00DC 
; 0000 00DD           }
; 0000 00DE           if(PINC.4==1 && PINC.5==0 && PINC.6==1)
_0x30:
	SBIS 0x13,4
	RJMP _0x34
	SBIC 0x13,5
...
; 0000 00E0           lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00E1           lcd_putsf("8");
	__POINTW2FN _0x0,14
	RCALL SUBOPT_0x1
; 0000 00E2           delay_ms(30);
; 0000 00E3 
; 0000 00E4           }
; 0000 00E5           if(PINC.4==1 && PINC.5==1 && PINC.6==0)
_0x33:
	SBIS 0x13,4
	RJMP _0x37
	SBIS 0x13,5
...
; 0000 00F1           PORTC.3= 0;
	CBI  0x15,3
; 0000 00F2           if(PINC.4==0 && PINC.5==1 && PINC.6==1)
	SBIC 0x13,4
	RJMP _0x42
	SBIS 0x13,5
	RJMP _0x42
...
; 0000 00F7 
; 0000 00F8           }
; 0000 00F9           if(PINC.4==1 && PINC.5==0 && PINC.6==1)
_0x41:
	SBIS 0x13,4
	RJMP _0x45
	SBIC 0x13,5
...
; 0000 00FB               lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00FC               lcd_putsf("0");
	__POINTW2FN _0x0,20
	RCALL SUBOPT_0x1
; 0000 00FD               delay_ms(30);
; 0000 00FE 
; 0000 00FF           }
; 0000 0100           if(PINC.4==1 && PINC.5==1 && PINC.6==0)
_0x44:
	SBIS 0x13,4
	RJMP _0x48
	SBIS 0x13,5
