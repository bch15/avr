...
; 0000 008F // RS - PORTA Bit 0
; 0000 0090 // RD - PORTA Bit 1
; 0000 0091 // EN - PORTA Bit 2
; 0000 0092 // D4 - PORTA Bit 4
; 0000 0093 // D5 - PORTA Bit 5
; 0000 0094 // D6 - PORTA Bit 6
; 0000 0095 // D7 - PORTA Bit 7
...
; 0000 00A1         PORTC.3=1;
	SBI  0x15,3
; 0000 00A2         if(PINC.5==0)
	SBIC 0x13,5
	RJMP _0xE
; 0000 00A3         {
; 0000 00A4             while(PINC.5==0)
_0xF:
	SBIC 0x13,5
	RJMP _0x11
; 0000 00A5             {
; 0000 00A6                 lcd_gotoxy(i,0);
	RCALL SUBOPT_0x0
...
; 0000 00C0 
; 0000 00C1        //**3**
; 0000 00C2         if(PINC.6==0)
_0xE:
	SBIC 0x13,6
	RJMP _0x15
; 0000 00C3         {
; 0000 00C4             while(PINC.6==0)
_0x16:
	SBIC 0x13,6
	RJMP _0x18
; 0000 00C5             {
; 0000 00C6                 lcd_gotoxy(i,0);
	RCALL SUBOPT_0x0
; 0000 00C7                 if(PINC.6==0)
	SBIC 0x13,6
	RJMP _0x19
; 0000 00C8                 {
; 0000 00C9                     op='d';
	LDI  R30,LOW(100)
	MOV  R5,R30
; 0000 00CA                     lcd_gotoxy(i,0);
	RCALL SUBOPT_0x0
; 0000 00CB                     lcd_putchar(op);
	RCALL SUBOPT_0x1
; 0000 00CC                     delay_ms(50);
; 0000 00CD                 }
; 0000 00CE                 if(PINC.6==0)
_0x19:
	SBIC 0x13,6
	RJMP _0x1A
; 0000 00CF                 {
; 0000 00D0                     op='e';
	LDI  R30,LOW(101)
	MOV  R5,R30
; 0000 00D1                     lcd_gotoxy(i,0);
	RCALL SUBOPT_0x0
; 0000 00D2                     lcd_putchar(op);
	RCALL SUBOPT_0x1
; 0000 00D3                     delay_ms(50);
; 0000 00D4                 }
; 0000 00D5                 if(PINC.6==0)
_0x1A:
	SBIC 0x13,6
	RJMP _0x1B
; 0000 00D6                 {
; 0000 00D7                     op='f';
	LDI  R30,LOW(102)
	MOV  R5,R30
; 0000 00D8                     lcd_gotoxy(i,0);
	RCALL SUBOPT_0x0
; 0000 00D9                     lcd_putchar(op);
	RCALL SUBOPT_0x1
