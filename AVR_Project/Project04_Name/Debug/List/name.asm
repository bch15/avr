...
_char0:
	.DB  0x7,0x9,0x1,0x1F,0x0,0xA,0x4,0x0
_char1:
	.DB  0x4,0xA,0x15,0x9,0x16,0x0,0x0,0x0
_char2:
	.DB  0x2,0x2,0x2,0x2,0x3,0x0,0x0,0x0
_char3:
	.DB  0x2,0x1,0x2,0x4,0x18,0x0,0x0,0x0
_char4:
	.DB  0x1,0x1,0x1,0x1F,0x0,0x2,0x0,0x0
_char5:
	.DB  0x2,0x2,0x2,0x2,0x3,0x0,0x0,0x0
_char6:
	.DB  0x2,0x0,0x2,0x5,0x14,0x1F,0x0,0x0
_char7:
	.DB  0x4,0xA,0x9,0x4,0x12,0x11,0xF,0x0

_0x0:
	.DB  0x4C,0x4E,0x61,0x6D,0x65,0x3A,0x0
_0x2000003:
	.DB  0x80,0xC0
...
;flash byte char4[8]={1,1,1,31,0,2,0,0};
;flash byte char5[8]={2,2,2,2,3,0,0,0};
;flash byte char6[8]={2,0,2,5,20,31,0,0};
;flash byte char7[8]={4,10,9,4,18,17,15,0};
;
;void define_char(byte flash *pc,byte char_code){
; 0000 002B void define_char(byte flash *pc,byte char_code){

	.CSEG
_define_char:
; .FSTART _define_char
; 0000 002C byte i,a;
; 0000 002D a=(char_code<<3)|0x40;
	ST   -Y,R26
	ST   -Y,R17
	ST   -Y,R16
;	*pc -> Y+3
...
;	a -> R16
	...
	ORI  R30,0x40
	MOV  R16,R30
; 0000 002E for(i=0; i<8; i++) lcd_write_byte(a++, *pc++);
	LDI  R17,LOW(0)
_0x4:
	CPI  R17,8
	BRSH _0x5
...
; 0000 00B0 lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 00B1 lcd_putsf("LName:");
	__POINTW2FN _0x0,0
	CALL _lcd_putsf
; 0000 00B2 lcd_putchar(7);
	LDI  R26,LOW(7)
	CALL _lcd_putchar
; 0000 00B3 lcd_putchar(6);
	LDI  R26,LOW(6)
	CALL _lcd_putchar
; 0000 00B4 lcd_putchar(5);
	LDI  R26,LOW(5)
	CALL _lcd_putchar
; 0000 00B5 lcd_putchar(4);
	LDI  R26,LOW(4)
	CALL _lcd_putchar
; 0000 00B6 lcd_putchar(3);
	LDI  R26,LOW(3)
	CALL _lcd_putchar
; 0000 00B7 lcd_putchar(2);
	LDI  R26,LOW(2)
	CALL _lcd_putchar
; 0000 00B8 lcd_putchar(1);
	LDI  R26,LOW(1)
	CALL _lcd_putchar
