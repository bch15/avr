...
;	a -> R16
	...
	ORI  R30,0x40
	MOV  R16,R30
; 0000 002E for(i=0; i<5; i++)lcd_write_byte(a++,*pc++);
	LDI  R17,LOW(0)
_0x4:
	CPI  R17,5
	BRSH _0x5
...
; 0000 009D // RS - PORTA Bit 0
; 0000 009E // RD - PORTA Bit 1
; 0000 009F // EN - PORTA Bit 2
; 0000 00A0 // D4 - PORTA Bit 4
; 0000 00A1 // D5 - PORTA Bit 5
; 0000 00A2 // D6 - PORTA Bit 6
; 0000 00A3 // D7 - PORTA Bit 7
; 0000 00A4 // Characters/line: 8
; 0000 00A5 lcd_init(20);
	LDI  R26,LOW(20)
	RCALL _lcd_init
...
_0xD:
	...
	BRLT _0xE
; 0000 00B8            {
; 0000 00B9              lcd_gotoxy(i,j);
	RCALL SUBOPT_0x0
; 0000 00BA              lcd_putchar(k);
; 0000 00BB 
...
_0x13:
	...
	BRLT _0x14
; 0000 00C2            {
; 0000 00C3              lcd_gotoxy(i,j);
	RCALL SUBOPT_0x0
; 0000 00C4              lcd_putchar(k);
; 0000 00C5 
; 0000 00C6              delay_ms(5);
; 0000 00C7            }
	MOVW R30,R8
	ADIW R30,1
	MOVW R8,R30
