...
_0x3:
	.DB  0x40,0x0,0xF9,0x0,0x24,0x0,0x30,0x0
	.DB  0x19,0x0,0x12,0x0,0x2,0x0,0xF8,0x0
	.DB  0x0,0x0,0x10
...
;int i;
;unsigned int num[]={0x40,0xF9,0x24,0x30,0x19,0x12,0x02,0xF8,0x00,0x10};
...
; 0000 0021     if(i<9)
	...
	BRGE _0x4
; 0000 0022     {
; 0000 0023       PORTA= num[++i];
	MOVW R30,R4
	ADIW R30,1
	RCALL SUBOPT_0x0
; 0000 0024     }
; 0000 0025     while(PIND.2==0);
_0x4:
_0x5:
	SBIS 0x10,2
	RJMP _0x5
...
; 0000 002B      if(i>0)
	...
	BRGE _0x8
; 0000 002C     {
; 0000 002D       PORTA= num[--i];
	MOVW R30,R4
	SBIW R30,1
	RCALL SUBOPT_0x0
; 0000 002E     }
; 0000 002F     while(PIND.3==0);
_0x8:
_0x9:
	SBIS 0x10,3
	RJMP _0x9
...
; 0000 007E // INT0: On
; 0000 007F // INT0 Mode: Low level
; 0000 0080 // INT1: On
; 0000 0081 // INT1 Mode: Low level
; 0000 0082 // INT2: Off
