...
_0x0:
	.DB  0x37,0x0,0x38,0x0,0x39,0x0,0x2F,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0093 // Characters/line: 20
; 0000 0094 lcd_init(20);
	LDI  R26,LOW(20)
	RCALL _lcd_init
; 0000 0095 DDRC=0x0f;
	LDI  R30,LOW(15)
	OUT  0x14,R30
; 0000 0096 PORTC=0Xf0;
	LDI  R30,LOW(240)
	OUT  0x15,R30
; 0000 0097 
; 0000 0098 while (1)
...
; 0000 00A2              delay_ms(1);
	...
	LDI  R27,0
	CALL _delay_ms
; 0000 00A3              if(PINC.4==0) {
	SBIC 0x13,4
	RJMP _0x11
; 0000 00A4                  lcd_gotoxy(i,0);
	RCALL SUBOPT_0x0
; 0000 00A5                  lcd_putsf("7");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 00A6              }
; 0000 00A7              if(PINC.5==0) {
_0x11:
	SBIC 0x13,5
	RJMP _0x12
; 0000 00A8                  lcd_gotoxy(i,0);
	RCALL SUBOPT_0x0
; 0000 00A9                  lcd_putsf("8");
	__POINTW2FN _0x0,2
	RCALL _lcd_putsf
; 0000 00AA              }
; 0000 00AB              if(PINC.6==0) {
_0x12:
	SBIC 0x13,6
	RJMP _0x13
; 0000 00AC                  lcd_gotoxy(i,0);
	RCALL SUBOPT_0x0
; 0000 00AD                  lcd_putsf("9");
	__POINTW2FN _0x0,4
	RCALL _lcd_putsf
; 0000 00AE              }
; 0000 00AF              if(PINC.7==0) {
_0x13:
	SBIC 0x13,7
	RJMP _0x14
; 0000 00B0                  lcd_gotoxy(i,0);
	RCALL SUBOPT_0x0
; 0000 00B1                  lcd_putsf("/");
	__POINTW2FN _0x0,6
	RCALL _lcd_putsf
...
; 0000 00BC          if(PINC.4==0) {
; 0000 00BD              lcd_gotoxy(0,0);
; 0000 00BE              lcd_putsf("4");
; 0000 00BF          }
; 0000 00C0          if(PINC.5==0) {
; 0000 00C1              lcd_gotoxy(0,0);
; 0000 00C2              lcd_putsf("5");
; 0000 00C3          }
; 0000 00C4          if(PINC.6==0) {
; 0000 00C5              lcd_gotoxy(0,0);
; 0000 00C6              lcd_putsf("6");
; 0000 00C7          }
; 0000 00C8          if(PINC.7==0) {
...
; 0000 00ED             lcd_clear();
; 0000 00EE          }
; 0000 00EF          if(PINC.5==0) {
; 0000 00F0              lcd_gotoxy(0,0);
; 0000 00F1              lcd_putsf("0");
; 0000 00F2          }
; 0000 00F3          if(PINC.6==0) {
; 0000 00F4              lcd_gotoxy(0,0);
; 0000 00F5              lcd_putsf("=");
; 0000 00F6          }
; 0000 00F7          if(PINC.7==0) {
